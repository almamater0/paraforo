...
class RegistrationForm(CleanEmailMixin, forms.ModelForm):
    ...
    email2 = forms.CharField(
        label=_("Confirmación de correo"),
        widget=forms.EmailInput,
        max_length=254,
        help_text=_("Escribe la misma dirección de correo de arriba"))
    ...
    def clean_email2(self):
        ...
        if email and email != email2:
            raise forms.ValidationError(
                _("Las direcciones de correo no coinciden."))
...
class LoginForm(AuthenticationForm):
    ...
    username = forms.CharField(
        label=_("Nombre de usuario o dirección de correo"),
        max_length=254)

    def __init__(self, *args, **kwargs):
        super(LoginForm, self).__init__(*args, **kwargs)
        self.error_messages['invalid_login'] = _("La contraseña no es válida.")
